...
class tblTransaction(db.Model):
    ...
    profit = db.Column(db.Numeric(10,4), nullable=True, default=0.00)
...
class tblPayment(db.Model):
    ...
    amount = db.Column(db.Numeric(10,4), nullable=True, default=0.0000)
    paid = db.Column(db.Numeric(10,4), nullable=True, default=0.0000)
    remain = db.Column(db.Numeric(10,4), nullable=True, default=0.0000)
    receive = db.Column(db.String(100), nullable=True, default='0,0')
    rate = db.Column(db.Numeric(10,4), nullable=True, default=4000)
    change = db.Column(db.Numeric(10,4), nullable=True, default=0.0000)
    createdOn = db.Column(db.DateTime, default=datetime.utcnow)
    orderedBy = db.Column(db.String(36), db.ForeignKey('tbl_customer.id'), nullable=False)
    createdBy = db.Column(db.String(36), db.ForeignKey('tbl_user.id'), nullable=False)
...
class tblProduct(db.Model):
    ...
    price = db.Column(db.Numeric(10,4), nullable=True, default=0.0000)
    currency = db.Column(db.String(100), nullable=False)
    priceCurrency = db.Column(db.Numeric(10,4), nullable=True, default=0.0000)
    discount = db.Column(db.String(3), nullable=True, default='')
...
class tblStock(db.Model):
    id = db.Column(db.String(36), primary_key=True)
    cost = db.Column(db.Numeric(10,4), nullable=True, default=0.00)
    costCurrency = db.Column(db.Numeric(16,4), nullable=True, default=0.00)
    currency = db.Column(db.String(100), nullable=False)
    rate = db.Column(db.Numeric(10,4), nullable=True, default=0.00)
    quantity = db.Column(db.Numeric(10,0), nullable=True, default=0)
    total = db.Column(db.Numeric(10,4), nullable=True, default=0.00)
...
class tblDrawer(db.Model):
    ...
    startCost = db.Column(db.Numeric(16,4), nullable=True, default=0.00)
    startedOn = db.Column(db.DateTime, default=datetime.utcnow)
